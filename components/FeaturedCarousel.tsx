  ...
  return (
    <div className="relative w-full bg-gradient-to-br from-zinc-900 via-zinc-800 to-zinc-900 dark:from-zinc-950 dark:via-zinc-900 dark:to-zinc-950">
      ...
      >
        ...
        <CarouselPrevious className="hidden sm:flex left-4 border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:left-8 cursor-pointer" />
        <CarouselNext className="hidden sm:flex right-4 border-zinc-700 bg-zinc-800/80 text-white hover:bg-zinc-700 hover:text-white sm:right-8 cursor-pointer" />
      </Carousel>
...
function FeaturedSlide({ product }: FeaturedSlideProps) {
  ...
  return (
    <div className="flex min-h-[400px] flex-col md:min-h-[450px] md:flex-row lg:min-h-[500px]">
        ...
        {mainImage ? (
          <>
            ...
            {product.category && (
              <Badge
                variant="secondary"
                className="w-fit bg-amber-500/20 text-amber-400 hover:bg-amber-500/30 absolute top-4 left-4 md:top-8 md:left-8"
              >
      ...
      <div className="flex w-full flex-col justify-center px-6 pb-12 pt-4 md:w-2/5 md:px-10 lg:px-16">
